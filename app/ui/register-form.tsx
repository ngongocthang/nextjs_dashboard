    ...
    <form action={dispatch} className="space-y-3">
      <div className="w-full">
        <div>
          ...
          <div className="relative">
            <input
              className={`peer block w-full rounded-md border border-gray-300 py-[9px] pl-10 text-sm outline-2 placeholder:text-gray-500 focus:border-gray-500 dark:border-gray-600 dark:bg-[#333] dark:text-white dark:placeholder:text-gray-500`}
              id="name"
              type="name"
              name="name"
              placeholder="Enter your name"
...
function CreateAccountButton() {
  return (
    <Button className="mt-4 w-full bg-gray-900 hover:bg-gray-800 text-white dark:bg-gray-300 dark:text-gray-900 dark:hover:bg-gray-400">
      Create Account <ArrowRightIcon className="ml-auto h-5 w-5 text-gray-50 dark:text-gray-900" />
    </Button>
//     <Button
//   className="mt-2 w-full bg-gray-900 hover:bg-gray-800 text-white dark:bg-gray-300 dark:text-gray-900 dark:hover:bg-gray-400"
//   style={{ backgroundColor: "rgb(0, 113, 242)" }}
 
// >
//   Create Account <ArrowRightIcon className="ml-auto h-5 w-5 text-white dark:text-white" />
// </Button>
