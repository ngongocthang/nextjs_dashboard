                  ...
                  <div
                    ...
                    <div className="flex w-full items-center justify-between border-b py-5">
                      <div className="flex w-1/2 flex-col">
                        ...
                        <p className="font-medium text-black">{customer.total_pending}</p>
                      </div>
                      <div className="flex w-1/2 flex-col">
                        <p className="text-xs text-black">Paid</p>
                        <p className="font-medium text-black">{customer.total_paid}</p>
                      </div>
                    </div>
                  ...
                  {customers.map((customer) => (
                    <tr key={customer.id} className="group">
                      <td className="whitespace-nowrap bg-white py-5 pl-4 pr-3 text-sm text-black group-first-of-type:rounded-md group-last-of-type:rounded-md sm:pl-6">
                        <div className="flex items-center gap-3">
                          <img src={customer.image_url} alt={customer.name} className="h-10 w-10 rounded-full" /><p>{customer.name}</p>
                        </div>
                      </td>
